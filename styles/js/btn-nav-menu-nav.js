$(function () {
	...
	var elts = [container, list, btn_block_top, btn_block_middle, btn_block_bottom, content, footer, sub_nav];
	var elts_class = ['transform-position', 'transform-color', 'rotate', 'rotate', 'rotate', 'hide', 'hide', 'hide'];
